...
import ReportSuccessModal from "../Report/ReportSuccessModal";

i18nIsoCountries.registerLocale(require("i18n-iso-countries/langs/en.json"));

class NewTinderCard extends Component {
  constructor(props) {
    super(props);
    this.state = {
      otherUser: this.props.item,
      pictureUrls: [],
    ...
    console.log("otherUser -> ", props.item);

    if (this.state.otherUser.photos === "undefined") {
      this.state.pictureUrls.push(this.state.otherUser.picture);
    } else if (
      this.state.otherUser.photos == null ||
      this.state.otherUser.photos.length == 0
    ) {
      this.state.pictureUrls.push(this.state.otherUser.picture);
    } else if (
      this.state.otherUser.photos &&
      this.state.otherUser.photos.length > 0
    ) {
      this.state.otherUser.photos.map((item, index) =>
  ...
  componentDidMount() {
    userService
      .get_request(
        ...
        `/match_rate/${this.state.otherUser.id}`
      )
      .then(res => {
        this.setState({
      ...
      .catch(err => {
        console.log("match_rate -> ", err);
      });
  }

  onPressLike(isLike) {
    const onSwiped = this.props.onSwiped;
    if (onSwiped) {
      if (isLike) {
        this.setState({
          isLikeCard: true
  ...
  onReportUser(val) {
    ...
    userService
      .post(
        this.props.userToken.access_token,
        `/users/report/${this.state.otherUser.id}`,
        body
      )
      .then(res => {
      ...
      >
        ...
        >
          <View>
            <Swiper
              ...
              dotColor="darkgrey"
              dotStyle={{
                marginBottom: !this.state.fullscreenMode
                  ? height * 0.6 - 50
                  : height - 50
              }}
            ...
            >
              ...
              <TouchableOpacity
                style={styles.mediumCircle}
                onPress={() => {
                  this.props.navigation.push("Gift", { to: otherUser });
                }}
              >
            ...
            <View style={{ marginTop: 10, paddingLeft: 15 }}>
              <View style={{ flexDirection: "row" }}>
                <Text style={[styles.name, { maxHeight: 30 }]}>
                  {getCorrrectName(otherUser.name)}
                </Text>
                {otherUser.is_share_age &&
                <Text style={styles.age}>
                  ,{userService.calcAge(otherUser.birthday)}
                </Text>}
                <View
                  style={{
                    flex: 1,
              ...
              <View style={styles.socialIconsWrap}></View>
            </View>
            ...
            >
              <View style={styles.swiperInsideView}>
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.good_etiquette}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.nice_profile}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.true_to_profile}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.well_mannered}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
              ...
              <View style={styles.swiperInsideView}>
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.bubbly_personality}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.intellectual}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.eloquent}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.great_sense_humor}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
              ...
              <View style={styles.swiperInsideView}>
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.great_style}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.gentlemanly}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.energetic}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.thoughtful}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
              ...
              <View style={styles.swiperInsideView}>
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.better_than_profile}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.confident}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.good_listener}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
                ...
                <TouchableOpacity style={{ alignItems: "center" }}>
                  ...
                  <Badge
                    value={this.state.otherUserRate.athletic}
                    containerStyle={{
                      position: "absolute",
                      top: -4,
                      right: -4
              ...
              <View style={styles.twoColumnRow}>
                ...
                >
                  <Icon
                    ...
                    name="map-marker"
                    color="#3cb9fc"
                    containerStyle={{ marginRight: 11, marginLeft: 0 }}
                  />
                  {otherUser.is_share_location && 
                  <Text
                    style={{ width: "80%" }}
                  >{`${otherUser.city}, ${otherUser.country}`}</Text>}
                </View>
                <View
                  style={{
                    flexDirection: "row",
                ...
                >
                  <Icon
                    ...
                    type="font-awesome"
                    color="#3cb9fc"
                    containerStyle={{ marginRight: 12, marginLeft: 4 }}
                  />
                  {otherUser.is_share_location && 
                  <Text>
                    {getDistance(
              ...
              <View style={styles.twoColumnRow}>
                ...
                >
                  <Icon
                    ...
                    size={17}
                    color="#3cb9fc"
                    containerStyle={{ marginLeft: 2, marginRight: 16 }}
                  />
              ...
              <View style={styles.twoColumnRow}>
                ...
                >
                  <Icon
                    ...
                    type="ionicon"
                    color="#3cb9fc"
                    containerStyle={{ marginLeft: 4, marginRight: 16 }}
                  />
            ...
            <View style={styles.categoryContainer}>
              <View style={styles.CategoryBox}>
                ...
                <Text>
                  ${this.kFormatter(Number(otherUser.income_from))} P.A.
                </Text>
              </View>
              <View style={styles.CategoryBox}>
        ...
        >
          <ReportModal
            ...
            onSubmit={val => {
              this.onReportUser(val);
            }}
          />
        </Overlay>

        <Overlay
          isVisible={this.state.isReportSuccessModal}
          width="auto"
          height="auto"
          borderRadius={14}
          overlayStyle={{ padding: 10 }}
...
export default withNavigation(connect(mapStateToProps)(NewTinderCard));
